	...
	class ScrollAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				HorizontalScrollViewItem scrollViewItem = new HorizontalScrollViewItem(
						mContext, getDemoView1(), getDemoView2());
				scrollViewItem.setRestCb(mRestCb);
